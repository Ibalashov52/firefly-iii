...
class ListController extends Controller
{
    ...
    public function attachments(Bill $bill): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.bills.attachments', [$bill->id]) . $this->buildParams());
    ...
    public function rules(Bill $bill): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.bills.rules', [$bill->id]) . $this->buildParams());
    ...
    public function transactions(Request $request, Bill $bill): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.bills.transactions', [$bill->id]) . $this->buildParams());
