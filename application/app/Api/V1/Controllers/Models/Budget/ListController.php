...
class ListController extends Controller
{
    ...
    public function attachments(Budget $budget): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.budgets.attachments', [$budget->id]) .
            $this->buildParams());
    ...
    public function budgetLimits(Budget $budget): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.budgets.budget-limits', [$budget->id]) .
            $this->buildParams());
    ...
    public function transactions(Request $request, Budget $budget): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.budgets.transactions', [$budget->id]) .
            $this->buildParams());
    ...
    public function withoutBudget(Request $request): JsonResponse
    {
        ...
        $paginator = $collector->getPaginatedGroups();
        $paginator->setPath(ListController . phproute('api.v1.budgets.without-budget') . $this->buildParams());
        $transactions = $paginator->getCollection();
