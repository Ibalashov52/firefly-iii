...
class ListController extends Controller
{
    ...
    public function attachments(Account $account): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.accounts.attachments', [$account->id]) .
            $this->buildParams());
    ...
    public function piggyBanks(Account $account): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.accounts.piggy-banks', [$account->id]) .
            $this->buildParams());
    ...
    public function transactions(Request $request, Account $account): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.accounts.transactions', [$account->id]) .
            $this->buildParams());
