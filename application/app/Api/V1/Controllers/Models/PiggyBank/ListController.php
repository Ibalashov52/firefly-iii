...
class ListController extends Controller
{
    ...
    public function attachments(PiggyBank $piggyBank): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.piggy-banks.attachments', [$piggyBank->id]) .
            $this->buildParams());
    ...
    public function piggyBankEvents(PiggyBank $piggyBank): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.piggy-banks.events', [$piggyBank->id]) .
            $this->buildParams());
