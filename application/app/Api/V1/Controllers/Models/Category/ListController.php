...
class ListController extends Controller
{
    ...
    public function attachments(Category $category): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.categories.attachments', [$category->id]) .
            $this->buildParams());
    ...
    public function transactions(Request $request, Category $category): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.categories.transactions', [$category->id]) .
            $this->buildParams());
