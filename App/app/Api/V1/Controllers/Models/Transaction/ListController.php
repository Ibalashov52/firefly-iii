...
class ListController extends Controller
{
    ...
    public function attachments(TransactionGroup $transactionGroup): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.transactions.attachments', [$transactionGroup->id]) .
            $this->buildParams());
    ...
    public function piggyBankEvents(TransactionGroup $transactionGroup): JsonResponse
    {
        ...
        $paginator->setPath(ListController .
            phproute('api.v1.transactions.piggy-bank-events', [$transactionGroup->id]) . $this->buildParams());
    ...
    public function transactionLinks(TransactionJournal $transactionJournal): JsonResponse
    {
        ...
        $paginator->setPath(ListController .
            phproute('api.v1.transaction-journals.transaction-links', [$transactionJournal->id]) . $this->buildParams());
