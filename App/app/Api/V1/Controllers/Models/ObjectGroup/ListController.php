...
class ListController extends Controller
{
    ...
    public function bills(ObjectGroup $objectGroup): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.currencies.bills', [$objectGroup->id]) .
            $this->buildParams());
    ...
    public function piggyBanks(ObjectGroup $objectGroup): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.object-groups.piggy-banks', [$objectGroup->id]) .
            $this->buildParams());
