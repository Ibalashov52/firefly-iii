...
class ListController extends Controller
{
    ...
    public function accounts(Request $request, TransactionCurrency $currency): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.currencies.accounts', [$currency->code]) .
            $this->buildParams());
    ...
    public function availableBudgets(TransactionCurrency $currency): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.currencies.available-budgets', [$currency->code]) .
            $this->buildParams());
    ...
    public function bills(TransactionCurrency $currency): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.currencies.bills', [$currency->code]) .
            $this->buildParams());
    ...
    public function budgetLimits(TransactionCurrency $currency): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.currencies.budget-limits', [$currency->code]) .
            $this->buildParams());
    ...
    public function recurrences(TransactionCurrency $currency): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.currencies.recurrences', [$currency->code]) .
            $this->buildParams());
    ...
    public function rules(TransactionCurrency $currency): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.rules.index') . $this->buildParams());
    ...
    public function transactions(Request $request, TransactionCurrency $currency): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.currencies.transactions', [$currency->code]) .
            $this->buildParams());
