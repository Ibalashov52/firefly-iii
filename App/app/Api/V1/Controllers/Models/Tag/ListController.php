...
class ListController extends Controller
{
    ...
    public function attachments(Tag $tag): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.tags.attachments', [$tag->id]) . $this->buildParams());
    ...
    public function transactions(Request $request, Tag $tag): JsonResponse
    {
        ...
        $paginator->setPath(ListController . phproute('api.v1.tags.transactions', [$tag->id]) . $this->buildParams());
